...
- [ArrayForLua](#arrayforlua)
- [ArrayForLua API](#arrayforlua-api)
    + [Array:BinaryFirst()](#array-binaryfirst--)
      - [Example](#example)
      - [Syntax](#syntax)
      - [Parameters](#parameters)
      - [Return Value](#return-value)
    + [Array:BinaryLast()](#array-binarylast--)
      - [Example](#example-1)
      - [Syntax](#syntax-1)
      - [Parameters](#parameters-1)
      - [Return Value](#return-value-1)
    + [Array:BlockSwap()](#array-blockswap--)
      - [Example](#example-2)
      - [Syntax](#syntax-2)
    ...
    + [Array:Entries()](#array-entries--)
      - [Example 1: Calling the Iterator's internal *Next()* function](#example-1--calling-the-iterator-s-internal--next----function)
      - [Example 2: Using `for`...`in` loop on an array](#example-2--using--for--in--loop-on-an-array)
      - [Example 3: Using `for`...`in` loop on a dictionary](#example-3--using--for--in--loop-on-a-dictionary)
      - [Syntax](#syntax-4)
    ...
    + [Array:Filter()](#array-filter--)
      - [Example 1: Filter a numeric array](#example-1--filter-a-numeric-array)
      - [Example 2: Filter a dictionary table](#example-2--filter-a-dictionary-table)
      - [Example 3: Filter items based on search criteria (query)](#example-3--filter-items-based-on-search-criteria--query-)
      - [Syntax](#syntax-7)
    ...
    + [Array:From()](#array-from--)
      - [Example 1: Array from string](#example-1--array-from-string)
      - [Example 2: Array from table](#example-2--array-from-table)
      - [Syntax](#syntax-11)
    ...
    + [Array:InsertionSort()](#array-insertionsort--)
      - [Example](#example-11)
      - [Syntax](#syntax-14)
    ...
    + [Array:Keys()](#array-keys--)
      - [Example 1: Calling the Iterator's internal *Next()* function](#example-1--calling-the-iterator-s-internal--next----function-1)
      - [Example 2: Using `for`...`in` loop](#example-2--using--for--in--loop)
      - [Syntax](#syntax-16)
